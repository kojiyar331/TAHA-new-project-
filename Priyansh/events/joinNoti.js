...
🕊️🌸... 𝑨𝒔𝒔𝒂𝒍𝒂𝒎𝑾𝒂𝒍𝒆𝒌𝒖𝒎 𝑮𝒖𝒚𝒔 𝑴𝒚 𝑵𝒂𝒎𝒆  𝑰𝒔🍒💙•••✦𝘽𝙤𝙩 𝙅𝙖𝙣𝙪✦•••💞🌿
...
`, attachment: fs.createReadStream(__dirname + "/cache/botjoin.mp4")} ,threadID));
        ...
        try {
            ...
            (typeof threadData.customJoin == "undefined") ? msg = "Hello Mr/Miss {name},\n─────────────────\n You're The {soThanhVien}Member ─────────────────\nOf {threadName} Group\n─────────────────\nPlease Enjoy Your Stay\n─────────────────\nAnd Make Lots Of Friends =)\n──────-°°__𝗧𝗿𝘂𝘀𝘁 𝗺e 🔐 °__!!>☁️✨❤️ My Owner  ✦͙͙͙͙❥⃝∗⁎.ʚ Shaan Khan ɞ.⁎∗❥⃝**͙✦͙͙͙ ❤️ Love you 😘 ummmma ❤️😍" : msg = threadData.customJoin;
            msg = msg
